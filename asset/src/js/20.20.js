webpackJsonp([20],Array(316).concat([
/* 316 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserAuthentication = function (_React$Component) {
		_inherits(UserAuthentication, _React$Component);

		function UserAuthentication(props) {
			_classCallCheck(this, UserAuthentication);

			var _this2 = _possibleConstructorReturn(this, (UserAuthentication.__proto__ || Object.getPrototypeOf(UserAuthentication)).call(this, props));
		...
		_createClass(UserAuthentication, [{
			...
			value: function componentDidMount() {
				...
				(0, _fetch.fetch_data_get)("/api/get_user_authentication_list", { truelove_admin_token: localStorage.truelove_admin_token }).then(function (result) {
					var user_authentication_list = [];
					result.body.user_authentication_list.map(function (ele, key) {
			...
			key: "look_up",
			value: function look_up(user_id, user_header, user_name, user_sex, user_age, user_area, pass_date) {
				var _this3 = this;

				var user_information = { user_id: user_id, user_header: user_header, user_name: user_name, user_sex: user_sex, user_age: user_age, user_area: user_area, pass_date: pass_date };
			...
			value: function render() {
				...
				var columns = [{ title: "昵称", dataIndex: "user_name", key: "user_name", render: function render(text) {
					...
					} }, { title: "性别", dataIndex: "user_sex", key: "user_sex" }, { title: "年龄", dataIndex: "user_age", key: "user_age" }, { title: "地区", dataIndex: "user_area", key: "user_area" }, { title: "通过认证日期", dataIndex: "pass_date", key: "pass_date" }, { title: "操作", key: "operation", render: function render(text, record) {
						return _react2.default.createElement(
							"span",
							null,
							_react2.default.createElement(
								...
								{ href: "#", onClick: function onClick() {
										return _this4.look_up(record.user_id, record.user_header, record.user_name, record.user_sex, record.user_age, record.user_area, record.pass_date);
									} },
								"查看"
							),
				...
				return _react2.default.createElement(
					"div",
					{ className: "user_authentication_wrap" },
					_react2.default.createElement(
						_spin2.default,
						...
						_react2.default.createElement(_table2.default, { columns: columns, expandedRowRender: function expandedRowRender(record) {
							...
							}, dataSource: this.state.user_authentication_list })
					),
					_react2.default.createElement(
						_modal2.default,
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											{ className: "pass_date" },
											"认证通过日期： ",
											this.state.user_information.pass_date
										)
									)
								),
								_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./user_authentication.scss", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./user_authentication.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".user_authentication_wrap {\n  margin-top: 32px; }\n", ""]);
