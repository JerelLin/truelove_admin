webpackJsonp([21],Array(316).concat([
/* 316 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css3 = __webpack_require__(321);
	...
	var _css5 = __webpack_require__(336);
	...
	var Users = function (_React$Component) {
		...
		_createClass(Users, [{
			...
			key: "get_users",
			value: function get_users(filter_select) {
				var _this = this;
				_this.setState({ loading: true });
				(0, _fetch.fetch_data_get)("/api/get_registered_users_list", { truelove_admin_token: localStorage.truelove_admin_token, filter_select: filter_select }).then(function (result) {
					var users_count = 0;
					var registered_users_list = [];
					users_count = result.body.registered_users_list.length;
					result.body.registered_users_list.map(function (ele, key) {
			...
			key: "look_up",
			value: function look_up(user_id, user_header, user_name, user_sex, user_age, user_area, registered_date, authentication_state, account_state) {
				var _this3 = this;

				var user_information = { user_id: user_id, user_header: user_header, user_name: user_name, user_sex: user_sex, user_age: user_age, user_area: user_area, registered_date: registered_date, authentication_state: authentication_state, account_state: account_state };
			...
			key: "handle_filter",
			value: function handle_filter(value) {
			...
			key: "handle_submit",
			value: function handle_submit(user_id) {
				...
				(0, _fetch.fetch_data_get)("/api/banned", { truelove_admin_token: localStorage.truelove_admin_token, user_id: user_id, banned_select: banned_select }).then(function (result) {
			...
			value: function render() {
				...
				var columns = [{ title: "昵称", dataIndex: "user_name", key: "user_name", render: function render(text) {
					...
					} }, { title: "性别", dataIndex: "user_sex", key: "user_sex" }, { title: "年龄", dataIndex: "user_age", key: "user_age" }, { title: "地区", dataIndex: "user_area", key: "user_area" }, { title: "注册日期", dataIndex: "registered_date", key: "registered_date" }, { title: "认证状态", dataIndex: "authentication_state", key: "authentication_state" }, { title: "账号状态", dataIndex: "account_state", key: "account_state" }, { title: "操作", key: "operation", render: function render(text, record) {
						return _react2.default.createElement(
							"span",
							null,
							_react2.default.createElement(
								...
								{ href: "#", onClick: function onClick() {
										return _this4.look_up(record.user_id, record.user_header, record.user_name, record.user_sex, record.user_age, record.user_area, record.registered_date, record.authentication_state, record.account_state);
									} },
								"查看"
							),
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ to: "/truelove_admin/chat", query: { user_id: record.user_id } },
								"对话"
							)
						);
					}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_select2.default,
							{ className: "filter_select", labelInValue: true, defaultValue: { key: "all_users" }, style: { width: 300 }, onChange: function onChange(value) {
									return _this4.handle_filter(value);
								} },
							_react2.default.createElement(
								Option,
								{ value: "all_users" },
							...
							_react2.default.createElement(
								Option,
								{ value: "not_auth_users" },
								"未认证用户"
							),
							_react2.default.createElement(
								Option,
								{ value: "temporary_banned_users" },
								"暂时封号用户"
							),
							_react2.default.createElement(
								Option,
								{ value: "forever_banned_users" },
								"永久封号用户"
							)
						)
					),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_table2.default, { columns: columns, expandedRowRender: function expandedRowRender(record) {
							...
							}, dataSource: this.state.registered_users_list })
					),
					_react2.default.createElement(
						_modal2.default,
						{ wrapClassName: "look_up_view",
							...
							onOk: function onOk() {
								return _this4.handle_submit(_this4.state.user_information.user_id);
							},
							onCancel: function onCancel() {
								return _this4.look_up_view_close();
							}
						},
						_react2.default.createElement(
							_spin2.default,
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											_reactRouter.Link,
											{ to: "/truelove_admin/send_news", query: { user_name: this.state.user_information.user_name, user_id: this.state.user_information.user_id }, className: "send_news_user" },
											"发送消息"
										)
									),
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											"注册日期： ",
											this.state.user_information.registered_date
										),
										_react2.default.createElement(
											"span",
											{ className: "authentication_state" },
											"认证状态： ",
											this.state.user_information.authentication_state
										),
										_react2.default.createElement(
											"span",
											{ className: "account_state" },
											"账号状态： ",
											this.state.user_information.account_state
										)
									),
									_react2.default.createElement(
										"div",
										...
										_react2.default.createElement(
											...
											{ labelInValue: true, defaultValue: { key: "not_banned" }, style: { width: 120 }, onChange: function onChange(value) {
													return _this4.handle_banned(value);
												} },
											_react2.default.createElement(
												Option,
												{ value: "not_banned" },
